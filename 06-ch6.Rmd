...
```{r ch6-vaccine-decision-table, echo=FALSE, out.width = '80%', message=FALSE, warning=FALSE}
knitr::include_graphics("img/vaccine-decision-table.png")
```
...
```{r ch6-vaccine-decisoes, echo=FALSE, out.width = '60%', message=FALSE, warning=FALSE}
knitr::include_graphics("img/vaccine-decisoes.png")
```
