...
```{r ch5-va-definicao, echo=FALSE, out.width = '60%', message=FALSE, warning=FALSE}
knitr::include_graphics("img/va/va.png")
```
...
```{r ch5-va-tipos, echo=FALSE,  out.width = '70%', message=FALSE, warning=FALSE}
knitr::include_graphics("img/va/va-tipos.png")
```
...
::: {.example name="Computadores defeituosos"} 
<br />
:::
...
```{r ch5-comp-fdp, echo=FALSE, out.width = '50%', message=FALSE, warning=FALSE}
knitr::include_graphics("img/comp-fdp.png")
```


```{r ch5-comp, echo=FALSE, fig.cap='Função distribuição de probabilidade do número de computadores defeituosos comprados.', out.width = '60%', message=FALSE, warning=FALSE}
...
```{r ch5-fdp-cont, echo=FALSE, out.width = '60%', message=FALSE, warning=FALSE}
knitr::include_graphics("img/fdp-cont.png")
```
...
```{r ch5-fdp-cont-2, echo=FALSE, out.width = '60%', message=FALSE, warning=FALSE}
knitr::include_graphics("img/fdp-cont-2.png")
```

::: {.example name="Projétil"} 
<br />
:::
...
```{r ch5-FDA, echo=FALSE, out.width = '60%', message=FALSE, warning=FALSE}
...
::: {.example name="Computadores defeituosos, continuação"} 
<br />
:::
...
```{r ch5-comp-FDA, echo=FALSE, out.width = '60%', message=FALSE, warning=FALSE}
knitr::include_graphics("img/comp-fda.png")
```
...
::: {.example name="Projétil, continuação"} 
<br />
:::
...
```{r ch5-comp-fdp-2, echo=FALSE, out.width = '50%', message=FALSE, warning=FALSE}
knitr::include_graphics("img/comp-fdp.png")
```
...
```{r ch5-skewness-kurtosis, echo=FALSE, fig.cap='Assimetria e Excesso. [Fonte](https://dataanalyticsedge.com/2017/06/16/descriptive-statistics-in-r/)', out.width = '100%', message=FALSE, warning=FALSE}
knitr::include_graphics("img/skewness-kurtosis.jpg")
```
